...
export function GridItem({ children, style, className, ...other }) {
    ...
    const props = {
        ...
        style: {
            ...
            transform: interpolate([styles.xy, styles.scale], (xy, s) => `translate3d(${xy[0]}px, ${xy[1]}px, 0) scale(${s})`),
            ...style,
        },
        ...other,
    };
    return typeof children === "function" ? (children(animated.div, props, {
        ...
        i,
        grid,
    })) : (React.createElement(animated.div, Object.assign({}, props), children));
}
